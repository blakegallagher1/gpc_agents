...
# Vector store ID for the ingested PDF (same as parking agent)
VECTOR_STORE_ID = "vs_67f06532f1008191921744f7b0643ab6"

# Agent instructions, focused on Chapter 3 - Processes
INSTRUCTIONS = (
    "You are an expert on the East Baton Rouge Zoning Code, specializing in Chapter 3 - Processes. "
    "Answer questions using the official zoning code as your primary source, focusing only on content from Chapter 3 - Processes. "
    "If a question is outside the scope of Chapter 3 - Processes, politely decline to answer. "
...
DB_PATH = os.path.join(os.path.dirname(__file__), "data", "Processes.db")
...
if __name__ == "__main__":
    import sys
    question = " ".join(sys.argv[1:]) or "What is the general process for obtaining a zoning permit?"
