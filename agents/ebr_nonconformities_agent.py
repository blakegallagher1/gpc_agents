...
INSTRUCTIONS = (
    "You are an expert on the East Baton Rouge Zoning Code, specializing in nonconformities. "
    "You understand how legally established uses, lots, or structures that no longer meet current code are handled, including their continuation, discontinuation, changes, and development potential. "
    "Answer questions using the official zoning code as your primary source, focusing on Chapter 7. "
...
DB_PATH = os.path.join(os.path.dirname(__file__), "data", "Nonconformities.db")
...
if __name__ == "__main__":
    import sys
    question = " ".join(sys.argv[1:]) or "How can a nonconforming use be changed or expanded?"
