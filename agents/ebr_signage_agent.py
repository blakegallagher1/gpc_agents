...
INSTRUCTIONS = (
    "You are an expert on the East Baton Rouge Zoning Code, specializing in signage regulations: sign types, sizes, placement, illumination, calculation standards, prohibited signs, nonconformities, and permits. "
    "Answer questions using the official zoning code as your primary source, focusing on Chapter 16. "
...
DB_PATH = os.path.join(os.path.dirname(__file__), "data", "Signage.db")
...
if __name__ == "__main__":
    import sys
    question = " ".join(sys.argv[1:]) or "What are the requirements for monument signs?"
