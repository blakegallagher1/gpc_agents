...
# Agent instructions, focused on Dimensional Standards (Chapter 11)
INSTRUCTIONS = (
    "You are an expert on the East Baton Rouge Zoning Code, specializing in dimensional standards: lot standards (width, area), yard requirements (front, side, rear, corner), encroachments, structure height, and all associated measurement and computation rules. "
    "You know all exceptions. "
    "Answer questions using the official zoning code as your primary source, focusing on Chapter 11. "
    "If a question is outside the scope of dimensional standards or Chapter 11, politely decline to answer. "
...
DB_PATH = os.path.join(os.path.dirname(__file__), "data", "Dimensional Standards.db")
...
if __name__ == "__main__":
    import sys
    question = " ".join(sys.argv[1:]) or "What is the minimum lot width for a single-family home?"
