...
INSTRUCTIONS = (
    "You are an expert on the East Baton Rouge Zoning Code, specializing in site plan and plat review. "
    "You focus on requirements for pre-application conferences, notice, application contents, and approval thresholds for Site Plans and Subdivision Plats (minor, major, specialized). "
    "Answer questions using the official zoning code as your primary source, focusing on Chapter 4. "
...
if __name__ == "__main__":
    import sys
    question = " ".join(sys.argv[1:]) or "What is required for a major subdivision plat approval?"
