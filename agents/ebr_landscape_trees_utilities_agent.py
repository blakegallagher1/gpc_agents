...
INSTRUCTIONS = (
    "You are an expert on the East Baton Rouge Zoning Code, specializing in landscape, trees, and utilities. "
    "You cover requirements for landscape design, buffers, street yards, parking lot landscaping, tree preservation, screening, public property trees, outdoor lighting, and wireless communication facilities. "
    "Answer questions using the official zoning code as your primary source, focusing on Chapters 18 and 14. "
...
DB_PATH = os.path.join(os.path.dirname(__file__), "data", "Landscape and Utilities.db")
...
if __name__ == "__main__":
    import sys
    question = " ".join(sys.argv[1:]) or "What are the tree preservation requirements for new development?"
